...
barplot <- function (data,
                     ...
                     xtitle,
                     ytitle){
  bar <- ggplot2::ggplot(data, aes(x={{x}}, y={{y}}, fill={{fill}}))+
...
boxplot <- function (data,
                     ...
                     xtitle,
                     ytitle){
    box <- ggplot2::ggplot(data, aes(x={{x}}, y={{y}}, fill={{fill}}))+
...
densityplot <- function (data,
                         ...
                         xtitle,
                         ytitle){
  den <- ggplot2::ggplot(data, aes(x={{x}}, color={{color}}))+
...
boxplot(data=data_filt,
        ...
        fill=condition,
        width_boxplot=0.5,
        plot_title="Normalized data distribution",
        label="",
        xtitle= "Label",
        ytitle="Intensity")
```
