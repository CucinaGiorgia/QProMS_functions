...
sig <- significant(data=r6$stat_table)
```
...
rba_reactome_interactors_static_p <- possibly(rba_reactome_interactors_static)
...
prova <- nodes %>% 
  ...
  pull(UNIPROT) %>% 
  map(.f = rba_reactome_interactors_static_p) 
 

boh <- as_tibble(do.call(rbind, prova)) %>% 
 dplyr::mutate(Source=test[[1]]$entities[[1]]$acc) %>% 
  dplyr::mutate(Count=test[[1]]$entities[[1]]$count) %>% 
  dplyr::mutate(Target1=test[[1]]$entities[[1]]$interactors[[1]]$acc) %>% 
  dplyr::mutate(Score1=test[[1]]$entities[[1]]$interactors[[1]]$score) 



test <- prova[2]

test[[1]]$entities[[1]]$acc #Source
test[[1]]$entities[[1]]$count #How many interactors
test[[1]]$entities[[1]]$interactors[[1]]$acc #Target
test[[1]]$entities[[1]]$interactors[[1]]$score #Score
